...
TwitchBox = new Box("Twitch Collection", "Not Purchasable", [],[], [fiveheadcube, clowncube, feelsbadmancube, brokenemotecube, isaaccube, kappacube, monkaScube, omegalulcube, pepecube, pogcube, poggerscube, twitchbotanguish, twitchbotcool, twitchbothappy, twitchbotkindasad, twitchbotp, twitchbotsad, twitchbotstraightface, twitchbotsurprised, twitchbotwinking, twitchbotwut, twitchheart, goldpepecube, twitchcube], "")
rewardboxes.push(TwitchBox)
SlimeBox = new Box("Slime Collection", "Not Purchasable", [], [], [goldslimecube, goldslimejar, greengoocube, greenslimecube, greenslimejar, noirslimecube, pinkslimejar, purplegoocube, purpleslimecube, purpleslimejar, redgoocube, redslimecube, redslimejar, yellowgoocube, yellowslimecube, yinyangslime, cookieslimecube, smugslimecube], '')
...
MythicalMaterialsBox = new Box("Mythical Materials Box", 5000, [], [], [dragonglass, fortunebone, lead, lightstone, demonsteel, aerothread, deliriumtitanium, beamdust, solarnickel, cratersoil, quakecopper, planarsilk, spectralwood, crowncobalt, dreamclay, chronomarble, utopiancotton, corruptresin, lovesand, electricfleece, fortunecloth, borderstone, enchantednylon, moltenzinc, edgebrass, warpedsilver], "sprites/mythicalmaterials/mythicalmaterials.png")
...
AspectsBox = new Box("Aspect's Box", 5000,[], [], [jscube, csscube, htmlcube, pastelpinkcube, musiccube, thinkinsightfullycube, ttoadcube, pastacube, animecube, sweatercube, friendcube, tftwoclickercube, updatecube, videogamecube, handcube, introversioncube, logiccube, aspectslaptop, claritycube], "sprites/aspectsbox/aspectsbox.png")
KingBox = new Box("sdomas Box", 01, [], [], [sdoma], "sprites/megabox/sdoma.png")
WoqaBox = new Box("woqas Box", 01, [], [], [woqa], "sprites/woqabox/woqabox.jpg")
JadenBox = new Box("Jadens Box", 01, [], [], [jaden], "sprites/Jadenbox/jaden.png")
